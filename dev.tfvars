...
public_ip_name = "Dev-thor-pip"         # Name of the public IP address 
nic_name       = "Dev-hulk-nic"         # Name of the network interface
nsg_name       = "Dev-avengers-nsg"     # Name of the network security group
vm_name        = "Dev-hulk-vm"          # Name of the virtual machine
